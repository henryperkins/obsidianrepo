...
export default class ChatModelManager {
  ...
  private getModelConfig(customModel: CustomModel): ModelConfig {
    ...
    const azureOpenAIConfig = {
      ...
      ...this.handleOpenAIExtraArgs(isO1Model || isO1PreviewModel, settings.maxTokens, settings.temperature),
    };
    ...
    const providerConfig: {
      ...
      [ChatModelProviders.AZURE_OPENAI]: azureOpenAIConfig,
    ...
    const baseAndProviderConfig = { ...baseConfig, ...selectedProviderConfig };

    //remove temperature and top_p for o1-preview
    if (isO1PreviewModel && baseAndProviderConfig.hasOwnProperty('temperature')) {
      delete baseAndProviderConfig.temperature;
    }

    return baseAndProviderConfig;
  }
