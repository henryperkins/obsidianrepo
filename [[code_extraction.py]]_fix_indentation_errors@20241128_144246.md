...
**user**: [code_extraction.py](code_extraction.py.md) fix indentation errors
[Timestamp: 2024/11/28 14:42:46]

**ai**: To fix the indentation errors in your `code_extraction.py` file, let's ensure that all code blocks are properly aligned. Here's the corrected version:
...
Make sure to check the alignment of each block and ensure that all methods and class definitions are properly indented. If there are any specific sections that still seem off, let me know!
[Timestamp: 2024/11/28 14:43:51]